...
const VTC_CONFIG = {
  ...
  // ── SUPABASE ──────────────────────────────────────────────────
  SUPABASE: {
    url:              process.env.NEXT_PUBLIC_SUPABASE_URL      || "https://mwjewdguvvmgzajfbjev.supabase.co",
    anon_key:         process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY || "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im13amV3ZGd1dnZtZ3phamZiamV2Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzQ2MjM5NjUsImV4cCI6MjA5MDE5OTk2NX0.U8ratVAm6zh9a1UD6Q4Uoay5akgUKnArOxx_PAvo1F8",
    service_role_key: process.env.SUPABASE_SERVICE_ROLE_KEY     || "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im13amV3ZGd1dnZtZ3phamZiamV2Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc3NDYyMzk2NSwiZXhwIjoyMDkwMTk5OTY1fQ.C4On-1nbZ0O_TJwQtA-d7zdsAKgb9UC6zrp3B5N0jwI",
  },

  // ── GOOGLE MAPS ───────────────────────────────────────────────
  GOOGLE_MAPS: {
    api_key: process.env.NEXT_PUBLIC_GMAPS_KEY || "AIzaSyDxdjJ1HyJoVgeP6NFoS2i4va-tdRjrJIA",
  },
